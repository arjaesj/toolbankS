      ...
      <MDBContainer>
        <MDBRow>
          <MDBAnimation type="slideInRight">
            <MDBCol>
              <MDBBtn color="black" href="/privacypolicy">
                View Privacy Policy
              </MDBBtn>
          ...
          <MDBAnimation type="slideInLeft">
            <MDBCol>
              <MDBCard className="card-body">
                <MDBCardTitle>Terms & Conditions</MDBCardTitle>
                <MDBCardBody>
                  <h3>
                    <strong>Welcome to ToolBank$!</strong>
                  </h3>

                  <p>
                    These terms and conditions outline the rules and regulations
                    for the use of ToolBank$'s Website, located at {""}
                    <a
                  ...
                  <p>
                    ...
                    and conditions. Do not continue to use ToolBank$ if you do
                  ...
                  <p>
                    Unless otherwise stated, ToolBank$ and/or its licensors own
                    the intellectual property rights for all material on
                    ToolBank$. All intellectual property rights are reserved.
                    You may access this from ToolBank$ for your own personal use
                    subjected to restrictions set in these terms and conditions.
                  </p>

                  <p>You must not:</p>
                  <ul>
                    <li>Republish material from ToolBank$</li>
                    <li>Sell, rent or sub-license material from ToolBank$</li>
                    <li>
                      Reproduce, duplicate or copy material from ToolBank$
                    </li>
                    <li>Redistribute content from ToolBank$</li>
                  </ul>
                  ...
                  <p>
                    You hereby grant ToolBank$ a non-exclusive license to use,
                  ...
                  <p>
                    ...
                    compensates the absence of ToolBank$; and (d) the link is in
                  ...
                  <p>
                    ...
                    inform us by sending an e-mail to ToolBank$. Please include
                  ...
                  <p>
                    No use of ToolBank$'s logo or other artwork will be allowed
